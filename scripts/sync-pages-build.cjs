...
for (const name of ["index.html", "404.html", "view.html", "assets", "pages-build"]) {
...
fs.cpSync(path.join(dist, "source-index.html"), path.join(root, "view.html"));
...
fs.cpSync(path.join(root, "view.html"), path.join(pagesBuild, "view.html"));
